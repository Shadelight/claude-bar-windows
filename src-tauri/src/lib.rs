...
pub fn run() {
    tauri::Builder::default()
        // Debe registrarse PRIMERO: si ya hay una instancia, esta callback
        // corre en la instancia viva y solo muestra su ventana en vez de
        // abrir otra copia (antes cada doble-clic dejaba un proceso huerfano).
